    ...
    <p class="content-title">회원가입</p><br><br>
        <table class="join-table">
            <tr>
                ...
                <td class="columnsize"><input type="text" placeholder=" 이메일을 입력해주세요" name="email" class="user-input join-input-short">&nbsp;
                <button class="minibtn">중복 확인</button></td>
            </tr>
            <tr>
                <td>비밀번호</td>
                <td><input type="password" placeholder=" 비밀번호 입력해주세요" name="password" class="user-input join-input"></td>
            </tr>
            <tr>
                <td>이름</td>
                <td><input type="text" placeholder=" 이름을 입력해주세요" name="name" class="user-input join-input"></td>
            </tr>
            <tr>
                <td>닉네임</td>
                <td><input type="text" placeholder=" 닉네임을 입력해주세요" name="nickname" class="user-input join-input"></td>
            </tr>
            <tr>
                <td>휴대전화번호</td>
                <td><input type="text" placeholder=" 휴대전화번호를 입력해주세요" name="phone" class="user-input join-input"></td>
            </tr>
            <tr>
                <td>인증번호</td>
            ...
            <tr>
                <td>생년월일</td>
                <td><input id="justDate" type="text" placeholder=" 날짜를 선택해주세요" name="birthday" class="user-input join-input"></td>
            </tr>
            <tr>
                <td>성별</td>
