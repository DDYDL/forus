...
<body>
	...
	<div class = "mycontent">
	 ...
	 <ul>
            <li>
 			<button type="submit" class="btn inputdate">기간 입력</button>
              <ol class="hoverdate">
                <li><a href="#">기간 설정</a></li>
 				<li class="calender" ><input id="datecalendar" type="text"> ~ <input class="calender" id="datecalendar" type="text"></li>
              </ol>
            </li>
            </ul>
            </div>
