...
public class SearchServiceImpl implements SearchService {
	...
	public List<Recruit_post> getRecruit_postList(List<String> areas, List<String> species, Integer page) throws Exception {
		...
		if(page>getMaxPage(areas,species)) return null;
	...
	@Override
	public Integer getMaxPage(List<String> areas, List<String> species) throws Exception {
		Map<String,Object> map = new HashMap<>();
		map.put("areas", areas);
		map.put("species", species);
		...
		// 최대 페이지 수 올림으로 계산
		return (int)Math.ceil((double)maxCount/10);
	}
